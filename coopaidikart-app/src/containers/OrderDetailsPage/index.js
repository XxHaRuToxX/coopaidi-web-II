        ...
        >
          <div className="delAdrContainer">
            <div className="delAdrDetails">
              <div className="delTitle">Dirección de Envío</div>
              <div className="delName">{orderDetails.address.name}</div>
              <div className="delAddress">{orderDetails.address.address}</div>
              <div className="delPhoneNumber">
                Número de Celular {orderDetails.address.mobileNumber}
              </div>
            </div>
            <div className="delMoreActionContainer">
              <div className="delTitle">Más Acciones</div>
              <div className="delName">Descargar invoice</div>
            </div>
          </div>
        </Card>
          ...
          >
            ...
            <div style={{ fontWeight: "500", fontSize: 14 }}>
              {orderDetails.orderStatus[3].isCompleted &&
                `Entregado el ${formatDate2(orderDetails.orderStatus[3].date)}`}
            </div>
          </Card>
        ))}
      </div>

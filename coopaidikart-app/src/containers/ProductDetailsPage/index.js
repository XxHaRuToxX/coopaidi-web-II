        ...
        <div>
          ...
          <div className="breed">
            <ul>
              ...
              <li><a href="#">Celulares</a><IoIosArrowForward /></li>
          ...
          <div className="productDetails">
            ...
            <div>
              ...
              <span className="ratingNumbersReviews">72,234 Ratings & 8,140 Vistas</span>
            </div>
            <div className="extraOffer">Extra S/. 4500 menos </div>
            <div className="flexRow priceContainer">
              <span className="price">S/. {product.productDetails.price}</span>
              <span className="discount" style={{ margin: '0 10px' }}>22% menos</span>
              {/* <span>i</span> */}
              </div>
            <div>
              <p style={{ 
